...
![revl, the SLIME-class IDE built on revision (a separate application) — a tour: the threaded REPL evaluating a form, Tab-completion, a syntax-highlighting editor with a line-number gutter, rename-symbol, the call tree, live colour-theme switching, the emoji palette, and window tiling](media/tv2-ide.gif)
