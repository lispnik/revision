# system-editor-windows

## Purpose

Provide a project window that presents a registered ASDF system's components as a
collapsible tree and lets the user open and close editor windows for the system's
source files directly from that tree.
