...
;;; Tier-1 render snapshot: draw the desktop into a headless screen and assert on
;;; the rendered TEXT and per-cell ATTRIBUTES -- terminal-free, deterministic, and
;;; able to check styling (the menu-hotkey highlight here; an underline elsewhere)
