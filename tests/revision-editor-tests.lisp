;;;; revision-editor-tests.lisp --- editor display-width (wide CJK / emoji) tests.
;;;;
;;;; The revision editor stores the cursor as a code-point index but lays out text in
...
;;;;
;;;; Run from the repo root:  sbcl --script tests/revision-editor-tests.lisp
